...
A lightweight [Nginx][nginx] [Docker image][docker_project] built from source atop [Alpine Linux][alpine_linux]. It is compiled from source using the same [configure arguments][nginx_configure] as the official, pre-built packages. Available on [GitHub][github_project].
    ...
    $ docker run --rm sickp/alpine-nginx:1.13.5-r1  # nginx -g 'daemon off';
...
##### `1.13.5-r1`, `1.13.5`, `1.13`, `mainline`, `latest`

[Dockerfile](https://github.com/sickp/docker-alpine-nginx/tree/master/versions/1.13.5-r1/Dockerfile) / [ChangeLog][nginx_changes] / 2017-09-05

    $ docker run --rm sickp/alpine-nginx:1.13.5-r1 about
    * Nginx 1.13.5
...
[Dockerfile](https://github.com/sickp/docker-alpine-nginx/tree/master/versions/1.13.4-r1/Dockerfile) / [ChangeLog][nginx_changes] / 2017-08-08

    $ docker run --rm sickp/alpine-nginx:1.13.4-r1 about
    * Nginx 1.13.4
    built by gcc 6.3.0 (Alpine 6.3.0)
...
[Dockerfile](https://github.com/sickp/docker-alpine-nginx/tree/master/versions/1.13.2-r1/Dockerfile) / [ChangeLog][nginx_changes] / 2017-06-27
    ...
    $ docker run --rm sickp/alpine-nginx:1.13.2-r1 about
    * Nginx 1.13.2
    built by gcc 6.3.0 (Alpine 6.3.0)
    built with LibreSSL 2.5.4
    TLS SNI support enabled
